...
interface OrderFormValues {
  customerId: string | null; // Changed to string to match potential ID type
  customerName: string | null;
  // Other potential form fields like notes, payment method etc.
}
...
export default function Component() {
  ...
  const handleCustomerSelect = (customer: CustomerResponse | null) => {
    ...
    setValue('customerId', customer ? String(customer.id) : null); // Convert ID to string if needed
    setValue('customerName', customer ? customer.name || null : null); // Ensure string or null
  };
      ...
      <form onSubmit={methods.handleSubmit(onSubmit)}>
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
          ...
          <div className="grid grid-cols-5 h-[calc(100vh-60px)] overflow-hidden">
            ...
            {/* Right Sidebar */}
            <div className="p-2 overflow-y-auto col-span-2 bg-white dark:bg-gray-800 border-l dark:border-gray-700 flex flex-col">
              {/* Customer Search (now CustomerComboBox) */}
